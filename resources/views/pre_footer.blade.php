      ...
      <div class="container">
            ...
            <div class="card-body py-9 py-xl-11">
              ...
              <div class="row align-items-center gy-6">
                <div class="col-lg-6 col-xl-7">
                  <h3 class="display-5 text-light">¿Ya estás listo para empezar?</h3>
        ...
        <div class="row gy-6 gy-lg-0 mt-14 mt-lg-20 mb-0">
          <div class="col-md-6 col-lg-6">
            <span class="fs-24 text-dark">Soluciones para</span>
            <div class="row mt-4">
              <div class="col-md-6 col-lg-6">
                <div class="widget">
          ...
          <!-- /column -->
          <div class="col-md-6 col-lg-6">
            <span class="fs-24 text-dark">Funcionalidades</span>
            <div class="row mt-4">
              <div class="col-md-6 col-lg-6">
                <div class="widget">
