    ...
    <div id="mobile_apps">
      ...
      <div id="mobile_search" class="navbar">
        <form action="{{url('/')}}/{{$country->id}}/market/search" method="GET">
          <input type="text" name="q" class="query" value="" placeholder="Servicios o Profesionales">
          <input type="text" name="location" class="location" value="" placeholder="Ciudad o Localidad">
